...
export default function ContactPage() {
  return (
    <main className="pt-20">
      ...
      {/* STICKY WHATSAPP */}
      <a href="https://wa.me/966508151408?text=As-salamu%20alaykum,%20I%20would%20like%20to%20inquire%20about%20booking%20a%20room." target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.4)] hover:scale-105 transition-transform duration-300 flex items-center justify-center group">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="https://wa.me/966508151408?text=As-salamu%20alaykum,%20I%20would%20like%20to%20inquire%20about%20booking%20a%20room." target="_blank" rel="noreferrer" className="text-[#25D366] text-sm mt-2 inline-block font-medium hover:underline">Message Us Now &rarr;</a>
              </div>
            </div>
          </div>
        </div>
