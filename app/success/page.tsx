    ...
    <main className="pt-20 bg-ivory min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6 my-12">
        <div className="bg-white p-10 md:p-16 rounded-none shadow-2xl text-center max-w-3xl border border-gray-100">
          ...
          <h1 className="font-playfair text-4xl md:text-5xl text-ink font-medium mb-4">{t('title')}</h1>

          <p className="text-ink/70 font-light text-lg mb-10 leading-relaxed">{t('desc')}</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href={whatsappUrl} target="_blank" rel="noreferrer" className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-10 py-4 font-medium hover:bg-[#1da851] transition-colors duration-300 shadow-xl rounded-none">
