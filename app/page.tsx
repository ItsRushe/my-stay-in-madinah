    ...
    <main className="pt-16 lg:pt-0 bg-ivory">
        ...
        <div className="max-w-[90rem] mx-auto w-full px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center relative z-10">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center order-2 lg:order-1 text-center lg:text-left mt-8 lg:mt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 w-full sm:w-auto justify-center lg:justify-start">
              <Link href="/rooms" className="bg-ink hover:bg-gold text-white px-8 py-4 text-center transition-all duration-500 font-medium tracking-wide w-full sm:w-auto shadow-xl">Reserve Your Room</Link>
              <Link href="/contact" className="border border-ink/20 hover:border-ink text-ink px-8 py-4 text-center transition-all duration-500 font-medium flex items-center justify-center gap-3 w-full sm:w-auto">Chat Direct</Link>
            </div>
          </div>

          <div className="lg:col-span-6 relative order-1 lg:order-2 flex justify-center lg:justify-end mt-12 lg:mt-0">
            <div className="relative w-full max-w-[90%] sm:max-w-md xl:max-w-lg aspect-[4/5] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
              <img src="/room-1.jpg" alt="Premium Madinah Room" className="w-full h-full object-cover animate-pan" />
            </div>
            <div className="absolute -bottom-6 -left-2 md:bottom-10 md:-left-8 bg-white/95 backdrop-blur-md p-5 rounded-xl shadow-xl border border-gray-100 flex items-center gap-4 animate-bounce" style={{ animationDuration: '3s' }}>
              <div className="w-12 h-12 bg-gold/10 rounded-full flex items-center justify-center text-gold text-2xl">★</div>
              <div>
      ...
      <section className="py-20 md:py-24 bg-white overflow-hidden">
        ...
        <div className="flex overflow-x-auto hide-scrollbar snap-x snap-mandatory gap-6 px-6 md:px-12 pb-10 w-full max-w-[100rem] mx-auto">
          {rooms?.map((room: any) => (
            <div key={room.id} className="snap-start shrink-0 w-[85vw] sm:w-[400px] bg-ivory rounded-2xl border border-gray-100 overflow-hidden shadow-lg group flex flex-col">
              <div className="h-64 w-full overflow-hidden relative">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-ink shadow-sm">{room.capacity}</div>
              </div>
              <div className="p-8 flex flex-col flex-grow">
                ...
                <Link href={`/rooms/${room.id}`} className="w-full block text-center border border-ink text-ink py-3 font-medium hover:bg-ink hover:text-white transition-colors duration-300">View Room</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-16 md:py-24 px-6 md:px-12 bg-ivory">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-gray-200 rounded-2xl overflow-hidden shadow-xl md:shadow-2xl">
      ...
      <section className="py-20 md:py-32 px-6 md:px-12 bg-ink text-ivory relative overflow-hidden">
        ...
        <div className="max-w-[90rem] mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl flex flex-col group relative">
              <div className="h-72 w-full relative overflow-hidden bg-gray-100">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-ink shadow-sm pointer-events-none">3-4 Hours</div>
              </div>
              <div className="p-8 flex-1 flex flex-col">
                ...
                <Link href="/tours" className="w-full text-center border-2 border-ink text-ink py-4 font-medium hover:bg-ink hover:text-white transition-colors duration-300">View Details</Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-2xl flex flex-col group relative">
              <div className="h-72 w-full relative overflow-hidden bg-gray-100">
                ...
                <div className="absolute top-4 right-4 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-ink shadow-sm pointer-events-none">4 Hours</div>
              </div>
              <div className="p-8 flex-1 flex flex-col">
                <div className="flex justify-between items-start mb-3">
      ...
      <footer className="bg-ink pt-20 md:pt-32 pb-8 md:pb-12 px-6 md:px-12 border-t border-white/5">
        <div className="max-w-4xl mx-auto text-center mb-16 md:mb-24 flex flex-col items-center">
          <Link href="/" className="flex flex-col items-center group mb-10 md:mb-12 cursor-pointer">
