  ...
  return (
    <main className="bg-ivory pt-20">
      ...
      <header className="bg-ink py-24 md:py-32 px-6 border-b border-white/10 text-center">
        <h1 className="font-playfair text-4xl md:text-6xl text-white font-medium mb-6">Your Digital Guestbook</h1>
        <p className="text-ivory/60 font-light text-lg max-w-2xl mx-auto">Everything you need for a seamless, peaceful stay in the Prophet's city.</p>
      </header>
      ...
      <section className="py-16 md:py-24 px-6 md:px-12 max-w-4xl mx-auto space-y-16 text-ink">
        ...
        <div className="border-l-2 border-gold pl-6 md:pl-10">
          <h2 className="font-playfair text-3xl font-medium mb-4">Welcome to Madinah</h2>
        ...
        <div className="border-l-2 border-gold pl-6 md:pl-10">
          ...
          <a href="https://wa.me/201067040337?text=Hi,%20I%20am%20a%20current%20guest%20and%20need%20assistance." target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-3 bg-[#25D366] text-white px-8 py-4 font-medium hover:bg-[#1da851] transition-colors duration-300 shadow-xl rounded-none notranslate" translate="no">
