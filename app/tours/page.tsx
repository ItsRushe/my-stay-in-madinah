            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className={`${index % 2 !== 0 ? 'order-1 lg:order-1' : 'order-1 lg:order-2'}`}>
                <div className="flex flex-wrap items-center gap-4 mb-4">
                  <span className="bg-gold/10 text-gold px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase">{tour.duration}</span>
                  <span className="bg-ink/5 text-ink px-3 py-1 rounded-full text-xs font-semibold tracking-wider uppercase">{tour.group_size}</span>
                </div>
                ...
                <div className="flex items-center gap-3 text-sm text-green-600 font-medium bg-green-50 p-4 rounded-xl mb-8 border border-green-100">
