...
export default async function RoomPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="pt-20 bg-ivory">
      ...
      {/* STICKY WHATSAPP */}
      <a href={`https://wa.me/201067040337?text=As-salamu%20alaykum,%20I%20would%20like%20to%20inquire%20about%20booking%20${room.name}.`} target="_blank" rel="noreferrer" className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-none shadow-[0_10px_40px_rgba(37,211,102,0.4)] hover:scale-105 transition-transform duration-300 flex items-center justify-center group">
        ...
        <div className="lg:col-span-2 text-ink">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 mb-8">
            ...
            <div className="flex items-center gap-3 font-light opacity-80">
                ...
                Seamless access to Ziyarah Sites
            </div>
          </div>
          
          {/* GOOGLE MAPS DIRECT LINK BUTTON */}
          <a 
            href="https://www.google.com/maps/search/?api=1&query=Al-Aziziyyah,+Madinah,+Saudi+Arabia" 
            target="_blank" 
            rel="noreferrer" 
